...
namespace TowerDefense
{
	namespace GameEngine
	{
		...
		public:
			...
			static bool circle_rect(const Circle& circle, const sf::FloatRect& rect, const float& angle_radian=0.f);
			...
			static bool circle_dot(const Circle& circle, const sf::Vector2f& vector2);
		};
